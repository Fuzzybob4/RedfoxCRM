        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              RedFox CRM is specifically designed for outdoor service professionals. From holiday lighting installations
              to year-round landscaping operations, we understand your unique challenges and workflows.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We understand the unique challenges of outdoor service businesses and built our CRM specifically for your
              needs.
            </p>
          </div>
