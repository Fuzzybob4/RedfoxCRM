    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          {/* Badge */}
          <div className="mb-8">
            <Badge className="bg-brand-orange/20 text-brand-yellow border-brand-orange/30 px-4 py-2 text-sm font-medium animate-pulse">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button
              asChild
              size="lg"
              className="bg-gradient-to-r from-brand-orange to-brand-yellow hover:opacity-90 text-brand-dark px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
            >
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-border text-foreground hover:bg-accent px-8 py-4 text-lg font-semibold backdrop-blur-sm bg-transparent"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-card/10 backdrop-blur-md rounded-lg p-6 border border-border">
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
          <button
            ...
            className="text-muted-foreground hover:text-foreground transition-colors duration-300 animate-bounce"
