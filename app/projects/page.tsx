...
const navItems = [
  ...
  { icon: <Briefcase className="h-5 w-5" />, label: "Projects", href: "/projects", active: true },
            ...
            <div className="bg-[#272e3f] rounded-lg p-6">
              <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-400 text-sm">| {projectCount} Projects</span>
                </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-gray-700">
                    <TableHead className="text-gray-400">Project ID</TableHead>
                ...
                <TableBody>
                  {projects.map((project) => (
                    <TableRow key={project.id} className="border-gray-700">
                      <TableCell className="font-medium text-white">PRJ-{project.id}</TableCell>
                      ...
                      <TableCell className="text-white">{project.deadline}</TableCell>
                      <TableCell>
                        <DropdownMenu>
