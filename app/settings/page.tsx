          ...
          <div className="container mx-auto py-8 px-4 max-w-5xl">
            ...
            >
              <TabsList className="bg-white border border-gray-200">
                <TabsTrigger
                  value="profile"
                  className="data-[state=active]:bg-[#F67721] data-[state=active]:text-white"
                >
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setBusinessProfile((prev) => (prev ? { ...prev, email: e.target.value } : null))
                          }
                          className="bg-white border-gray-300 text-gray-900 mt-1"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setBusinessProfile((prev) => (prev ? { ...prev, phone: e.target.value } : null))
                          }
                          className="bg-white border-gray-300 text-gray-900 mt-1"
                        />
                      </div>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setBusinessProfile((prev) => (prev ? { ...prev, address: e.target.value } : null))
                        }
                        className="bg-white border-gray-300 text-gray-900 mt-1"
                      />
                    </div>
                    <div className="grid grid-cols-3 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setBusinessProfile((prev) => (prev ? { ...prev, city: e.target.value } : null))
                          }
                          className="bg-white border-gray-300 text-gray-900 mt-1"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setBusinessProfile((prev) => (prev ? { ...prev, state: e.target.value } : null))
                          }
                          className="bg-white border-gray-300 text-gray-900 mt-1"
                        />
                      </div>
